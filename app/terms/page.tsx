      ...
      <section className="mx-auto w-full max-w-4xl px-6 pt-36 pb-20 flex-grow">
        ...
        >
          <p className="text-lg leading-relaxed text-muted-foreground font-light">
            By using Auralix services, you agree to our terms: orders require payment before production begins,
            delivered videos become your property after full payment, revisions are limited as per your chosen
            package, and cancellations after production starts may not be refundable.
          </p>
          <p className="text-lg leading-relaxed text-muted-foreground font-light">
